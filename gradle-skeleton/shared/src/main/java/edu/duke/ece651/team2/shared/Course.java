...
public class Course {
     ...
     * @throws IOException if anything happens while recording the students' status
     *                     at the end of the class
     */
    public void endLecture(Lecture lecture, ArrayList<String> lateStudentsID, ArrayList<AttendanceStatus> status)
            throws IOException {
